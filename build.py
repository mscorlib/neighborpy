...
# define exclude dirs
exclude_dirs = ['.git', '__pycache__', 'test', 'logs', 'venv', '.idea', 'datas', '.vscode']
# defile exclude files
exclude_files = ['*.md', '.gitignore', '.python-version', 'requirements.txt', '*.pyc', '*.c', 'compile.py', 'app.py', 'demo.py', 'pipfile', '__init__.py']
ext_modules = []
